...
export function ChangelogActions({ entryId, projectId, isPublished }: ChangelogActionsProps) {
  ...
  async function handleTogglePublish() {
    ...
    try {
      ...
      await apiFetchClient(`/v1/changelog/dashboard/${projectId}/${entryId}`, token, {
        method: 'PATCH',
