            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span
                    className={`ml-auto text-xs font-medium px-2 py-0.5 rounded-full ${cfg.badge}`}
                  >
                    {colItems.length}
                  </span>
                </div>
        ...
        {submitted && (
          <div className="text-center space-y-1">
            ...
            <p className="text-xs text-neutral-500">
              We&apos;ll review it and add it to the roadmap if it fits.
            </p>
            <button
              onClick={() => {
                setSubmitted(false);
        ...
        {showForm && !submitted && (
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <label
                  className="text-xs font-medium text-neutral-400 mb-1 block"
                  htmlFor="idea-title"
                >
