    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden lg:flex lg:w-1/2 flex-col overflow-hidden bg-[#08090d]">
        ...
        <div className="relative z-10 flex-1 flex items-center justify-center px-10">
          <div className="relative w-full max-w-xs">
            {/* Feedback card */}
            <div
              className="absolute -top-20 -left-4 w-56 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 shadow-2xl"
            ...
            >
              ...
              <p className="text-xs text-white/70 mb-3 leading-relaxed">
                "Dark mode would be a killer feature for power users…"
              </p>
              <div className="flex items-center gap-2">
                <div className="w-5 h-5 rounded-full bg-indigo-500/40 text-[9px] text-white flex items-center justify-center font-medium">
                  A
                </div>
            ...
            {/* Analytics card */}
            <div
              className="absolute -top-4 right-0 w-48 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 shadow-2xl"
            ...
            {/* Waitlist card */}
            <div
              className="absolute top-28 -left-8 w-44 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 shadow-2xl"
            ...
            >
              ...
              <div className="flex -space-x-1.5 mt-2">
                ...
                <div className="w-5 h-5 rounded-full border border-white/10 bg-white/10 text-[8px] text-white flex items-center justify-center">
                  +
                </div>
              </div>
            </div>
            ...
            {/* Testimonial card */}
            <div
              className="absolute top-36 right-2 w-52 rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-4 shadow-2xl"
            ...
            >
              ...
              <p className="text-[11px] text-white/70 leading-relaxed">
                "Saved us weeks of backend work. Plug and play."
              </p>
            ...
            {/* Changelog pill */}
            <div
              className="absolute bottom-8 left-1/2 -translate-x-1/2 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm px-4 py-2 shadow-xl flex items-center gap-2"
      ...
      <div className="flex w-full lg:w-1/2 flex-col items-center justify-center bg-white dark:bg-[#08090d] px-8">
        ...
        <div className="w-full max-w-sm text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-white/40">Sign in to your dashboard</p>
          ...
          <p className="mt-6 text-xs text-gray-400 dark:text-white/20">
            ...
            <a
              href="https://sassmaker.com/terms"
            ...
            and{' '}
            <a
              href="https://sassmaker.com/privacy"
              className="underline hover:text-gray-600 dark:hover:text-white/40"
            >
              Privacy Policy
            </a>
