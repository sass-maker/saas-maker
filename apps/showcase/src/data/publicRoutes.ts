...
const fixedRoutes: PublicRoute[] = [
  ...
  },
  {
    id: 'launchdesk',
    path: '/launchdesk',
    description: 'LaunchDesk launch-destination catalog with source-attributed metrics',
    kind: 'collection',
    markdown: [
      '# LaunchDesk',
      '',
      'A provenance-honest catalog of 966 launch and submission destinations. Reported DR, link type, pricing and submission routes are shown with their source claims rather than smoothed away.',
      '',
      'The dataset is generated from the `launchdesk` checkout; the full local app there adds per-product queues, submission tracking and a link checker.',
      '',
