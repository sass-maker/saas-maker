...
const CORE = [
  ...
  },
  {
    ...
    color: '#10b981', size: 'tall', href: 'https://github.com/sarthakagrawal927/CodeVetter',
  },
  {
    ...
    color: '#c026d3', size: 'tall', href: 'https://github.com/sarthakagrawal927/reel-pipeline',
  },
  {
    n: '004', name: 'High Signal', initials: 'Hs', tag: 'Editorial · core',
    desc: 'A public signal log for AI infrastructure and semiconductors.',
    color: '#84cc16', size: 'wide', href: 'https://github.com/sarthakagrawal927/high-signal',
  },
  {
  ...
  },
  {
    ...
    color: '#06b6d4', size: 'std', href: 'https://github.com/sarthakagrawal927/tinygpt',
  },
  {
    n: '007', name: 'RolePatch', initials: 'Rt', tag: 'AI · core',
    desc: 'AI-powered resume tailoring for a specific role and a specific story.',
    color: '#f43f5e', size: 'wide', href: 'https://github.com/sarthakagrawal927/resume-tailor',
  },
];

const ACTIVE = [
  { name: 'free-ai', desc: 'OpenAI-compatible gateway for free LLM providers.', color: '#fbbf24', href: 'https://github.com/sarthakagrawal927/free-ai' },
  { name: 'truehire', desc: 'AI-powered candidate vetting platform.', color: '#6366f1', href: 'https://github.com/sarthakagrawal927/truehire' },
  { name: 'starboard', desc: 'AI-built project management dashboard.', color: '#14b8a6', href: 'https://github.com/sarthakagrawal927/starboard' },
  { name: 'reader', desc: 'Web annotator for documents and articles.', color: '#94a3b8', href: 'https://github.com/sarthakagrawal927/reader' },
  { name: 'email-manager', desc: 'Unified email management and automation.', color: '#3b82f6', href: 'https://github.com/sarthakagrawal927/email-manager' },
  { name: 'open-historia', desc: 'Interactive historical timeline platform.', color: '#f97316', href: 'https://github.com/sarthakagrawal927/open-historia' },
  { name: 'everythingrated', desc: 'Ratings and reviews — for everything.', color: '#ef4444', href: 'https://github.com/sarthakagrawal927/everythingrated' },
  { name: 'looptv', desc: 'TV-like app for curated YouTube channels.', color: '#a855f7', href: 'https://github.com/sarthakagrawal927/looptv' },
  { name: 'anime_list', desc: 'MAL explorer for anime and manga lists.', color: '#ec4899', href: 'https://github.com/sarthakagrawal927/anime_list' },
  { name: 'linkchat', desc: 'Real-time chat, built with Next.js.', color: '#0ea5e9', href: 'https://github.com/sarthakagrawal927/linkchat' },
  { name: 'today-little-log', desc: 'Daily logging and micro-journaling.', color: '#a8a29e', href: 'https://github.com/sarthakagrawal927/today-little-log' },
  { name: 'swe-interview-prep', desc: 'Interview prep tooling for engineers.', color: '#22c55e', href: 'https://github.com/sarthakagrawal927/swe-interview-prep' },
  { name: 'significanthobbies', desc: 'Personal hobby mapping and journey visualizer.', color: '#f472b6', href: 'https://github.com/sarthakagrawal927/significanthobbies' },
];
...
const SPEC = [
  ...
  ['Origin', '2024 →'],
  ['License', 'MIT'],
  ['Source', 'github.com/sarthakagrawal927/saas-maker'],
];
