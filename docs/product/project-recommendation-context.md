...
- `docs/README.md`
- `docs/operations/always-on-automation-setup.md`
- `docs/operations/baseline-2026-04-27.md`
- `docs/operations/cf-shields-state.md`
- `docs/architecture/droid-roadmap.md`
- `docs/architecture/droid.md`
- `docs/product/fleet-registry.md`
- `docs/operations/migration-plan.md`
- `docs/operations/stale-artifact-review.md`
- `docs/architecture/symphony.md`
- `docs/architecture/task-cloud-audit.md`
- `docs/development/testing-backlog.md`
- `docs/architecture/decisions/2026-06-20-tooling-plan-superseded.md`
