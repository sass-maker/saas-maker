...
| AI feedback summarizer and app-store/review digest                                                | `saas-maker`                                    | This is a direct extension of feedback widgets, analytics, tasks, and product modules. Plan: [`docs/architecture/decisions/2026-06-04-ai-feedback-digest-module.md`](../architecture/decisions/2026-06-04-ai-feedback-digest-module.md). |
