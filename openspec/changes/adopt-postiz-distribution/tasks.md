...
- [x] 4.2 Establish `services/content-factory` with the generation-only contract and migrate the canonical render/package entrypoints while preserving history.
- [x] 4.3 Route existing render engines through Content Factory manifests and verify current local generation smoke cases.
