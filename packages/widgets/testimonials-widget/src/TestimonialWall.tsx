...
import type { TestimonialWallProps } from './types';
          ...
          <div key={t.id} className="smw-tm-card">
            <div className="smw-tm-card-header">
              {t.author_avatar_url ? (
                ...
                <div className="smw-tm-avatar-placeholder">
            ...
            <div className="smw-tm-card-stars">
              {[1, 2, 3, 4, 5].map((star) => (
                <span
                  key={star}
                  className={`smw-tm-card-star ${star <= t.rating ? '' : 'smw-tm-card-star--empty'}`}
                >
                  &#9733;
                </span>
              ))}
            ...
            {t.image_url && (
              <img className="smw-tm-card-image" src={t.image_url} alt="Testimonial attachment" />
            )}

            {t.tweet_url && (
              <a
                className="smw-tm-card-tweet"
                href={t.tweet_url}
                target="_blank"
